...
6. If you cannot verify enough currently playing movies that match ALL constraints, say that clearly and return fewer options. Do NOT fill the list with unrelated movies just to reach 5 results.
